...
set externalIncludeDir=/I..\external\GLFW\include /I..\external\ImGui\include /I..\external\
set externallib=opengl32.lib user32.lib gdi32.lib kernel32.lib shell32.lib ..\external\GLFW\lib\glfw3.lib
set cppfiles=..\phyvis\main.cpp ..\external\Imgui\src\*.c ..\external\ImGui\src\*.cpp 
