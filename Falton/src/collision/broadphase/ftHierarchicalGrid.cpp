...
ftBroadphaseHandle ftHierarchicalGrid::addShape(const ftShape *shape,
...
void ftHierarchicalGrid::addCollidingPairInBucket(ftElem *elem,
                                                  uint32 bucketIndex,
...
void ftHierarchicalGrid::insertElemToBucket(ftElem *elem, uint32 bucketIndex)
{
    ...
    if (m_elemBucket[bucketIndex] != nullptr)
        m_elemBucket[bucketIndex]->prev = elem;
