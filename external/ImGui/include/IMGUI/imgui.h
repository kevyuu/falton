...
namespace ImGui
{
    ...
    IMGUI_API void          SetNextWindowPosCenterH(float yPos, ImGuiSetCond cond = 0);         // set next window position to be centered on screen horizontally. call before Begin()
