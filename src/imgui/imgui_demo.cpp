...
void ImGui::ShowTestWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Popups & Modal windows"))
    {
        ...
        if (ImGui::TreeNode("Context menus"))
        {
            ...
            static ImVec4 color (0.8f, 0.5f, 1.0f, 1.0f);
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // You can seek and display only the lines that are visible using the ImGuiListClipper helper, if your m_elements are evenly spaced and you have cheap random access to the m_elements.
        ...
        // and appending newly m_elements as they are inserted. This is left as a task to the user until we can manage to improve this example code!
